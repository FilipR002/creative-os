'use client';
// ─── Admin Layout ─────────────────────────────────────────────────────────────
// Shell for all /admin/* pages with full observability sidebar.
    ...
    <div style={{ minHeight: '100vh', background: '#080910', fontFamily: 'system-ui, sans-serif', color: '#f0f0f0', display: 'flex' }}>
      ...
      <aside style={{ width: 228, flexShrink: 0, background: '#0d0e14', borderRight: '1px solid #1e2330', display: 'flex', flexDirection: 'column', position: 'fixed', top: 0, left: 0, bottom: 0, zIndex: 20 }}>
        ...
        <div style={{ padding: '18px 16px 14px', borderBottom: '1px solid #1e2330' }}>
          <a href="/app/dashboard" style={{ textDecoration: 'none', display: 'flex', alignItems: 'center', gap: 9 }}>
        ...
        <div style={{ padding: '12px 14px', borderTop: '1px solid #1e2330' }}>
          <a href="/app/dashboard" style={{ display: 'block', padding: '7px 10px', background: 'rgba(255,255,255,0.03)', border: '1px solid #1e2330', borderRadius: 7, color: '#444', fontSize: 12, textDecoration: 'none', textAlign: 'center' }}>
            ← Back to App
          </a>
        </div>
      </aside>
